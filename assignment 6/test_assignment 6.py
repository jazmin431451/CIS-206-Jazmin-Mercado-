...
def test_assignment_6_decode_rle_value_is_correct():
    ...
    assert assignment_6.decode_rle("aa") == "aa"
    assert assignment_6.decode_rle("abc") == "abc"
    assert assignment_6.decode_rle("abbc")== "abbc"
    assert assignment_6.decode_rle("aaabcc") == "aaabcc"
    assert assignment_6.decode_rle(str("aaaaaaaaaa")) == "aaaaaaaaaa"
